    ...
    <div className="container my-5 py-2">
        <div className="row">
            <div className="col-12 mb-5">
                <h1 className="display-6 fw-bolder text-center">NEWS OF UPCOMING COUPONS!!!!</h1>
                <hr />
                <img src="./images/News/M2.webp" className="card-img" alt="Background" height="300px" />
            ...
            <div>
            <img src="./images/News/m1.webp" className="card-img" alt="Background" height="300px" />
            ...
            <div>
            <img src="./images/News/m3.webp" className="card-img" alt="Background" height="300px" />
            ...
            <div>
            <img src="./images/News/m4.webp" className="card-img" alt="Background" height="300px" />
            ...
            {/* <div>
            <img src="assets/news5.png" className="card-img" alt="Background" height="300px" />
            ...
            {/* <div>
            <img src="assets/news6.png" className="card-img" alt="Background" height="300px" />
